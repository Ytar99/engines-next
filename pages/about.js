...
const features = [
  {
    ...
    text: "Отправка заказов в день оформления по всей России",
  },
  {
        ...
        <Grid container spacing={4} sx={{ mb: 6 }}>
          <Grid item xs={12} md={6}>
            <Typography variant="body1" paragraph sx={{ fontSize: { xs: "1rem", sm: "1.1rem" } }}>
              Компания АвтоДВС - ведущий поставщик автозапчастей для коммерческого транспорта в Северо-Западном регионе.
              Мы специализируемся на комплектации двигателей и трансмиссий для грузовых автомобилей и спецтехники.
            </Typography>
            <Typography variant="body1" paragraph sx={{ fontSize: { xs: "1rem", sm: "1.1rem" } }}>
              Наш складской комплекс площадью 5000 м² содержит более 50 000 наименований запчастей, что позволяет
              оперативно комплектовать заказы любой сложности.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
            <Box
