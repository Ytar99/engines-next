...
export const routes = [
  ...
  { path: "/crm/settings", allowedRoles: ["ADMIN"], navItem: { text: "Настройки", icon: <SettingsIcon /> } },
  ...
  // API
  { path: "/api/crm/db/restore", allowedRoles: ["ADMIN"] },
  { path: "/api/crm/db/backup", allowedRoles: ["ADMIN"] },
